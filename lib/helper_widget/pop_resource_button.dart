...
class _MyMenuState extends State<MyMenu> with SingleTickerProviderStateMixin {
  ...
  // get Small View
  // getMediumView(StateSetter setState) {
  //   return Row(
  //     crossAxisAlignment: CrossAxisAlignment.start,
  //     mainAxisAlignment: MainAxisAlignment.start,
  //     children: [
  ...
  //                         Container(
  //                           margin:
  //                               const EdgeInsets.only(left: 11.0, right: 25),
  //                           child: const Text(
  //                             "Upload new",
  //                             style: TextStyle(
  //                                 color: Color(0xffFFFFFF),
  ...
  //                           return Padding(
  //                             padding:
  //                                 const EdgeInsets.only(left: 16, right: 70),
  ...
  //                     // ? TimeRangeResult(stringToTimeOfDay(Time1!)!,stringToTimeOfDay(Time2!)!)
  //                     // : null,
