...
class ShowMoreTextPopups {
  ...
  ShowMoreTextPopups(this.context,
      {double? height,
      double? width,
    ...
    this._popupHeight = height ?? 28;
    this._popupWidth = width ?? 185;
    this._text = text ?? '';
    ...
    this._padding = padding ?? EdgeInsets.only(top: 9);
  }
